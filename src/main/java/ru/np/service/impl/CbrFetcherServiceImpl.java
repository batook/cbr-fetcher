...
public class CbrFetcherServiceImpl extends WebServiceGatewaySupport implements CbrFetcherService {
    ...
    private static Logger log = Logger.getLogger(CbrFetcherServiceImpl.class);
    ...
    public CbrCurrency getCursOnDateXML(String code, Date date) {
        ...
        log.info("getCursOnDateXML start");
        ...
        log.info("getCursOnDateXML got response: " + response);
        ...
        for(ValuteCursOnDate cursOnDate : values) {
            ...
            if(cursOnDate.getVchCode().equalsIgnoreCase(code)) {
